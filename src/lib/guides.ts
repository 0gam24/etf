...
export const GUIDE_CLUSTERS: GuideCluster[] = [
  {
    title: 'ETF 기초·입문',
    description: 'ETF가 무엇인지부터 펀드와의 차이, 비용·괴리율까지 — 시작 전 꼭 보는 기본기.',
    slugs: ['etf-basics', 'etf-vs-fund', 'etf-fee', 'etf-nav-tracking'],
  },
  {
    title: '세금·절세 계좌',
    description: 'ETF 세금과 ISA·연금 같은 절세 계좌 — 세후 수익을 지키는 법.',
    slugs: ['etf-tax', 'isa-account-etf', 'isa-vs-pension', 'retirement'],
  },
  {
    title: '배당·인컴',
  ...
  {
    title: '해외·환율',
    description: '미국 등 해외 지수 ETF와 환헤지·환노출 — S&P500 vs 나스닥 비교 포함.',
    slugs: ['overseas-etf', 'sp500-vs-nasdaq', 'currency-hedge'],
  },
  {
    title: '전략·자산배분',
