...
export const GUIDE_CLUSTERS: GuideCluster[] = [
  {
    ...
    slugs: ['etf-basics', 'how-to-buy-etf', 'etf-vs-fund', 'etf-vs-stock', 'etf-fee', 'etf-nav-tracking', 'kodex-vs-tiger'],
  },
  {
    title: '세금·절세 계좌',
  ...
  },
  {
    ...
    slugs: ['monthly-dividend', 'covered-call', 'us-dividend', 'etf-dividend', 'reit-etf'],
  },
  {
    title: '테마·섹터',
    description: '방산·AI·반도체·2차전지 등 특정 테마에 집중하는 섹터 ETF.',
    slugs: ['defense-etf', 'ai-semi-etf', 'battery-etf'],
  },
  {
    title: '해외·환율',
