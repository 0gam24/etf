...
export interface GuideDef {
  ...
  section: '월배당 가이드' | '커버드콜 가이드' | '테마 ETF 가이드' | '은퇴 자산 가이드' | '배당주 가이드' | '환헤지 가이드' | '해외상장 가이드' | 'ETF 입문 가이드' | 'ETF 세금 가이드' | 'ETF 비용 가이드' | 'ETF 비교 가이드' | 'ETF 분배금 가이드' | 'ETF 적립식 가이드' | 'ETF 리밸런싱 가이드' | 'ETF 괴리율 가이드' | 'ETF 레버리지 가이드' | 'ETF 채권 가이드' | 'ISA 계좌 가이드' | 'ETF 매매 가이드' | 'ETF 금 가이드' | 'ETF 리츠 가이드';
  /**
...
export const GUIDE_CLUSTERS: GuideCluster[] = [
  {
    title: 'ETF 기초·입문',
    description: 'ETF가 무엇인지부터 펀드와의 차이, 비용·괴리율, 운용사 비교까지 — 시작 전 꼭 보는 기본기.',
    slugs: ['etf-basics', 'how-to-buy-etf', 'etf-vs-fund', 'etf-fee', 'etf-nav-tracking', 'kodex-vs-tiger'],
  },
  {
    title: '세금·절세 계좌',
    description: 'ETF 세금과 ISA·연금 같은 절세 계좌 — 세후 수익을 지키는 법.',
    slugs: ['etf-tax', 'domestic-vs-overseas-tax', 'isa-account-etf', 'isa-vs-pension', 'retirement'],
  },
  {
    title: '배당·인컴',
  ...
  {
    title: '해외·환율',
    description: '미국 등 해외 지수 ETF와 환헤지·환노출 — S&P500 vs 나스닥, 환헤지 vs 환노출 비교 포함.',
    slugs: ['overseas-etf', 'sp500-vs-nasdaq', 'currency-hedge', 'hedge-vs-unhedged'],
  },
  {
    title: '전략·자산배분',
    description: '적립식·리밸런싱·채권·금·레버리지 — 포트폴리오를 굴리고 위험을 관리하는 전략.',
    slugs: ['etf-dca', 'etf-rebalancing', 'bond-etf', 'gold-etf', 'leveraged-inverse-etf'],
  },
];
